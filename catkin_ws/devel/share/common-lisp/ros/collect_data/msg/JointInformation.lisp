...
(cl:defmethod cl:initialize-instance :after ((m <JointInformation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointInformation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name collect_data-msg:<JointInformation> is deprecated: use collect_data-msg:JointInformation instead.")))

(cl:ensure-generic-function 'joint_pos-val :lambda-list '(m))
(cl:defmethod joint_pos-val ((m <JointInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader collect_data-msg:joint_pos-val is deprecated.  Use collect_data-msg:joint_pos instead.")
  (joint_pos m))

(cl:ensure-generic-function 'joint_vel-val :lambda-list '(m))
(cl:defmethod joint_vel-val ((m <JointInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader collect_data-msg:joint_vel-val is deprecated.  Use collect_data-msg:joint_vel instead.")
  (joint_vel m))

(cl:ensure-generic-function 'joint_cur-val :lambda-list '(m))
(cl:defmethod joint_cur-val ((m <JointInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader collect_data-msg:joint_cur-val is deprecated.  Use collect_data-msg:joint_cur instead.")
  (joint_cur m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <JointInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader collect_data-msg:mode-val is deprecated.  Use collect_data-msg:mode instead.")
  (mode m))
